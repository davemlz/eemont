...
The eemont package extends the ee.Image and ee.ImageCollection classes with the method :code:`scaleAndOffset()`:
...
The :code:`scaleAndOffset()` method scales each image according to the *Scale* and *Offset* parameters. 
