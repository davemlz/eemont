...
class Test(unittest.TestCase):
    ...
    def test_BBoxFromQuery(self):
        ...
        test = ee.Geometry.BBoxFromQuery("Colombia", user_agent="eemon-geometry-test-BBoxFromQuery")
        self.assertIsInstance(test, ee.geometry.Geometry)

    def test_PointFromQuery(self):
        """Test the PointFromQuery constructor"""
        test = ee.Geometry.PointFromQuery("Colombia", user_agent="eemon-geometry-test-PointFromQuery")
        self.assertIsInstance(test, ee.geometry.Geometry)
    ...
    def test_PointFromShortPlusCode(self):
        ...
        test = ee.Geometry.PointFromPlusCode(code, user_agent="eemont-geometry-test-PointFromShortPlusCode")
        self.assertIsInstance(test, ee.geometry.Geometry)
