...
class Test(unittest.TestCase):
    ...
    def test_L5(self):
        ...
        L5_tested = L5.closest('2000-01-15',2,'year').maskClouds().scaleAndOffset().spectralIndices(indices)
        self.assertIsInstance(L5_tested, ee.imagecollection.ImageCollection)
        
    def test_L4(self):
        """Test the image collection module for Landsat 4"""
        L4_tested = L4.closest('1990-01-15').maskClouds().scaleAndOffset().spectralIndices(indices)
    ...
    def test_MCD43A4(self):
        ...
        MCD43A4_tested = MCD43A4.closest('2020-01-15').scaleAndOffset().spectralIndices(indices)
    ...
    def test_MOD09GQ(self):
        ...
        MOD09GQ_tested = MOD09GQ.closest('2020-01-15').scaleAndOffset().spectralIndices(indices)
    ...
    def test_MOD09GA(self):
        ...
        MOD09GA_tested = MOD09GA.closest('2020-01-15').maskClouds().scaleAndOffset().spectralIndices(indices)
    ...
    def test_MOD09Q1(self):
        ...
        MOD09Q1_tested = MOD09Q1.closest('2020-01-15').maskClouds().scaleAndOffset().spectralIndices(indices)
    ...
    def test_MOD09A1(self):
        ...
        MOD09A1_tested = MOD09A1.closest('2020-01-15').maskClouds().scaleAndOffset().spectralIndices(indices)
    ...
    def test_MYD09GQ(self):
        ...
        MYD09GQ_tested = MYD09GQ.closest('2020-01-15').scaleAndOffset().spectralIndices(indices)
    ...
    def test_MYD09GA(self):
        ...
        MYD09GA_tested = MYD09GA.closest('2020-01-15').maskClouds().scaleAndOffset().spectralIndices(indices)
    ...
    def test_MYD09Q1(self):
        ...
        MYD09Q1_tested = MYD09Q1.closest('2020-01-15').maskClouds().scaleAndOffset().spectralIndices(indices)
    ...
    def test_MYD09A1(self):
        ...
        MYD09A1_tested = MYD09A1.closest('2020-01-15').maskClouds().scaleAndOffset().spectralIndices(indices)
    ...
    def test_S2_online(self):
        """Test the image collection module for Sentinel-2"""
        S2_tested = S2.closest('2020-01-15').preprocess().spectralIndices(indices,online = True)
        self.assertIsInstance(S2_tested, ee.imagecollection.ImageCollection)
    ...
    def test_L5(self):
        """Test the image collection module for Landsat 5"""
        L5_tested = L5.closest('2000-01-15',2,'year').preprocess().spectralIndices(indices)
        self.assertIsInstance(L5_tested, ee.imagecollection.ImageCollection)
    ...
    def test_MCD43A4(self):
        """Test the image collection module for MCD43A4"""
        MCD43A4_tested = MCD43A4.closest('2020-01-15').preprocess().spectralIndices(indices)
        self.assertIsInstance(MCD43A4_tested, ee.imagecollection.ImageCollection)
    ...
    def test_MOD09GQ(self):
        """Test the image collection module for MOD09GQ"""
        MOD09GQ_tested = MOD09GQ.closest('2020-01-15').preprocess().spectralIndices(indices)
        self.assertIsInstance(MOD09GQ_tested, ee.imagecollection.ImageCollection)
    ...
    def test_MOD09GA(self):
        """Test the image collection module for MOD09GA"""
        MOD09GA_tested = MOD09GA.closest('2020-01-15').preprocess().spectralIndices(indices)
        self.assertIsInstance(MOD09GA_tested, ee.imagecollection.ImageCollection)
    ...
    def test_MOD09Q1(self):
        """Test the image collection module for MOD09Q1"""
        MOD09Q1_tested = MOD09Q1.closest('2020-01-15').preprocess().spectralIndices(indices)
        self.assertIsInstance(MOD09Q1_tested, ee.imagecollection.ImageCollection)
        
    def test_MOD09A1(self):
        """Test the image collection module for MOD09A1"""
        MOD09A1_tested = MOD09A1.closest('2020-01-15').preprocess().spectralIndices(indices)
        self.assertIsInstance(MOD09A1_tested, ee.imagecollection.ImageCollection)
    ...
    def test_MYD09GQ(self):
        """Test the image collection module for MYD09GQ"""
        MYD09GQ_tested = MYD09GQ.closest('2020-01-15').preprocess().spectralIndices(indices)
        self.assertIsInstance(MYD09GQ_tested, ee.imagecollection.ImageCollection)
    ...
    def test_MYD09GA(self):
        """Test the image collection module for MYD09GA"""
        MYD09GA_tested = MYD09GA.closest('2020-01-15').preprocess().spectralIndices(indices)
        self.assertIsInstance(MYD09GA_tested, ee.imagecollection.ImageCollection)
    ...
    def test_MYD09Q1(self):
        """Test the image collection module for MYD09Q1"""
        MYD09Q1_tested = MYD09Q1.closest('2020-01-15').preprocess().spectralIndices(indices)
        self.assertIsInstance(MYD09Q1_tested, ee.imagecollection.ImageCollection)
        
    def test_MYD09A1(self):
        """Test the image collection module for MYD09A1"""
        MYD09A1_tested = MYD09A1.closest('2020-01-15').preprocess().spectralIndices(indices)
        self.assertIsInstance(MYD09A1_tested, ee.imagecollection.ImageCollection)
